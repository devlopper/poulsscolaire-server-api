...
/**
 * Cette classe représente le filtre de {@link SchoolConfigurationDto}.
 *
 * @author Christian
 *
 */
@Getter
@Setter
public class SchoolConfigurationFilter extends AbstractIdentifiableFilter {

  String schoolIdentifier;

  public SchoolConfigurationFilter(FilterDto dto) {
    super(dto);
  }

  public SchoolConfigurationFilter() {}
  ...
  public static final String JSON_SCHOOL_IDENTIFIER = SchoolConfigurationDto.JSON_SCHOOL_IDENTIFIER;
