...
public class PaymentDto extends AbstractIdentifiableCodableAuditableDto {
  ...
  @JsonbProperty(JSON_IS_FOR_SUBSIDY_AS_STRING)
  private String isForSubsidyAsString;
  ...
  public static final String JSON_IS_FOR_SUBSIDY = "estPourSubvention";
  public static final String JSON_IS_FOR_SUBSIDY_AS_STRING = "estPourSubventionChaine";
