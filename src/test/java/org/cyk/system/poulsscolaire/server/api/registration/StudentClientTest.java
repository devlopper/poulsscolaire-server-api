...
class StudentClientTest {
  ...
  void listenBeforeEach() {
    ...
    client = new StudentClient().service(service);
  }
  ...
  void create() {
    ...
    assertInstanceOf(CreateResponseDto.class, client.create(new StudentCreateRequestDto()));
  }
  ...
  void getOne() {
    Response response = Mockito.mock(Response.class);
    Mockito.when(response.getStatus()).thenReturn(Response.Status.OK.getStatusCode());
    Mockito.when(response.readEntity(StudentDto.class)).thenReturn(new StudentDto());
    Mockito.when(service.getOne(any())).thenReturn(response);
    assertInstanceOf(StudentDto.class, client.getOne(null, null, null, null));
  }
  ...
  void getByIdentifier() {
    ...
    assertInstanceOf(StudentDto.class, client.getByIdentifier(null, null, null, null));
  }
