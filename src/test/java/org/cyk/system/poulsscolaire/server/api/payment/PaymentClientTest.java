...
class PaymentClientTest {
  ...
  void listenBeforeEach() {
    ...
    client = new PaymentClient().service(service);
  }
  ...
  void getOne() {
    Response response = Mockito.mock(Response.class);
    Mockito.when(response.getStatus()).thenReturn(Response.Status.OK.getStatusCode());
    Mockito.when(response.readEntity(PaymentDto.class)).thenReturn(new PaymentDto());
    Mockito.when(service.getOne(any())).thenReturn(response);
    assertInstanceOf(PaymentDto.class, client.getOne(null, null, null, null));
  }
  ...
  void getByIdentifier() {
    ...
    assertInstanceOf(PaymentDto.class, client.getByIdentifier(null, null, null, null));
  }
