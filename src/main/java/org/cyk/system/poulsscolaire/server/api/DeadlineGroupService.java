...
public interface DeadlineGroupService extends SpecificService {
  ...
  String CREATE_IDENTIFIER = "CREATION_GROUPE_ECHEANCE";
  ...
  @Operation(operationId = CREATE_IDENTIFIER, summary = "Création d'un groupe d'échéance",
  ...
  @Operation(operationId = GET_MANY_IDENTIFIER,
      description = "Ce service permet d'obtenir des groupes d'échéance")
  ...
  @Operation(operationId = GET_ONE_IDENTIFIER,
      description = "Ce service permet d'obtenir un groupe d'échéance")
  Response getOne(GetOneRequestDto request);

  String GET_BY_IDENTIFIER_IDENTIFIER = "OBTENTION_PAR_IDENTIFIANT_GROUPE_ECHEANCE";
  ...
  @Operation(operationId = GET_BY_IDENTIFIER_IDENTIFIER,
      description = "Ce service permet d'obtenir par identifiant un groupe d'échéance")
  Response getByIdentifier(GetByIdentifierRequestDto request);

  String UPDATE_IDENTIFIER = "MISE_A_JOUR_GROUPE_ECHEANCE";
  ...
  @Operation(operationId = DELETE_IDENTIFIER,
      description = "Ce service permet de supprimer un groupe d'échéance")
